    ...
    return (
        <div className="bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <p className="mt-4 text-lg text-neutral-600">This is your Student Dashboard.</p>
                <div className="mt-8 p-8 border-dashed border-2 border-neutral-300 rounded-lg text-center">
                    ...
                    <p className="text-neutral-500 mt-2">Widgets for your enrolled courses, progress, certificates, and job recommendations will appear here.</p>
                </div>
            </div>
        </div>
    );
